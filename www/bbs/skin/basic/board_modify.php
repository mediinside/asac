...
<table class="board_write">
    ...
    <tbody>
        <tr>
          <th scope="row">제목</th>
          <td><input type="text" class="txt full" title="제목 입력" placeholder="제목을 입력해 주세요." id="jb_title" name="jb_title" value="<?=$jb_title;?>" /></td>
        </tr>
        <!--tr>
          <th scope="row">작성자</th>
  ...
  <div class="btn-group right">
    ...
    <a href="javascript:history.go(-1);" class="btn btn-middle btn-gray">취소</a>
  </div>
