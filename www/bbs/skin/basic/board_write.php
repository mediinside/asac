...
<form name="frm_Board" id="frm_Board" action="<?=$get_par;?>" method="post" enctype="multipart/form-data">
  ...
  <table class="board_write">
    ...
    <tbody>
        <tr>
          <th scope="row">제목</th>
          <td><input type="text" class="txt full" title="제목 입력" autocomplete="off" placeholder="제목을 입력해 주세요." id="jb_title" name="jb_title" /></td>
        </tr>
        <!--tr>
          <th scope="row">작성자</th>
  ...
  <div class="btn-group right">
    <a href="#;" id="img_submit" class="btn btn-default">글쓰기</a>
