	...
	$(document).ready(function(){	
		...
		$('#base_form').validate({
			rules: {	
				...
				mb_password: { required: true, minlength: 5, maxlength:15, alphanumeric:true},
			...
			messages: {	
				...
				mb_password: { required: "패스워드를 입력하세요", minlength: $.format("비밀번호는 {0}자 이상 입력하시오"), maxlength: $.format("비밀번호는 {0}자 이상 입력할수 없습니다") },
