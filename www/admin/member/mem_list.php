			...
			<ul>				
				...
				<li>
					...
					<select name="search_key" id="search_key">
                        ...
                        <option value="mb_major" <? if($_GET['search_key'] == "mb_major"){ echo "selected";}?>>학과</option>
                        <option value="mb_snum" <? if($_GET['search_key'] == "mb_snum"){ echo "selected";}?>>학번</option>
					</select>
					</span>
						...
						<tbody>
							<?
								...
								for ($i = 0 ; $i < $data_list_cnt ; $i++) {
									...
									$mb_major 		= $data_list[$i]['mb_major'];	
									$mb_snum 		= $data_list[$i]['mb_snum'];	
