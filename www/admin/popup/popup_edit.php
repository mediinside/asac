					...
					<tbody>
						...
						<tr>
						  ...
						  <tr>
							...
							<td>
                				<input type="radio" name="pop_type2" id="pop_type2" value="W" <? if($pop_type2 == "W"){ echo "checked";} ?> />새창팝업
                                <input type="radio" name="pop_type2" id="pop_type2" value="L"  <? if($pop_type2 == "L"){ echo "checked";}  ?>/>레이어팝업
							</td>
						</tr>
						<tr>
